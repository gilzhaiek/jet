...
public class RawDataLogger extends AbstractThreadedLogger {
    ...
    protected void write(Message msg) {
        ...
        rowBuilder[ColumnIndex.Yaw.ordinal()] = sensorValues.yaw + ",";
        rowBuilder[ColumnIndex.Roll.ordinal()] = sensorValues.pitch + ",";
        rowBuilder[ColumnIndex.Pitch.ordinal()] = sensorValues.roll + ",";

        rowBuilder[ColumnIndex.Altitude.ordinal()] = sensorValues.altitude + ",";

        rowBuilder[ColumnIndex.GPSSpeed.ordinal()] = sensorValues.speed + ",";

        rowBuilder[ColumnIndex.Pressure.ordinal()] = sensorValues.getPres() + ",";

        rowBuilder[ColumnIndex.Accuracy_android.ordinal()] = sensorValues.accuracy + ",";
	...
	rowBuilder[ColumnIndex.TrueCadence.ordinal()] = sensorValues.trueCadence + ",";

	rowBuilder[ColumnIndex.WheelSpeed.ordinal()] = sensorValues.wheelSpeed + ",";

	rowBuilder[ColumnIndex.CalcCadence.ordinal()] = sensorValues.calcCadence + ",";
