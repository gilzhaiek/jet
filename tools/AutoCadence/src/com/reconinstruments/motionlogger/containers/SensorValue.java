package com.reconinstruments.autocadence.containers;
...
public class SensorValue {
    ...
    public int trueCadence, calcCadence;
    ...
    synchronized public SensorValue clone() {
        ...
        cloned.wheelSpeed = wheelSpeed;

        cloned.trueCadence = trueCadence;
        cloned.calcCadence = calcCadence;
