...
public class BluetoothGattCharacteristic {
     ...
     * Recon: use it to store the ATT handler
     * @hide
     */
    protected int mAtthandle;
    ...
    /*package*/ BluetoothGattCharacteristic(BluetoothGattService service,
                                            UUID uuid, int handle,
                                            int properties, int permissions) {
        initCharacteristic(service, uuid, handle, properties, permissions);
    }
    ...
    /**
     * Returns a descriptor with a given Atthandle out of the list of
     * descriptors for this characteristic.
     *
     * @return GATT descriptor object or null if no descriptor with the
     *         given Atthandle was found.
     * @hide        
     */
    public BluetoothGattDescriptor getDescriptor(int Atthandle) {
        for(BluetoothGattDescriptor descriptor : mDescriptors) {
            if (descriptor.getHandle() == Atthandle) {
                return descriptor;
            }
        }
        return null;
