...
public class Vertices {
	...
	public Vertices(ShaderProgram program, int maxVertices, int maxIndices)  {
		...
		mPositionHandle = GLES20.glGetAttribLocation(program.getHandle(), "vPosition");
		mTextureCoordinateHandle = GLES20.glGetAttribLocation(program.getHandle(), "vTexture");
		mMVPIndexHandle = GLES20.glGetAttribLocation(program.getHandle(), "a_MVPMatrixIndex");
	}
