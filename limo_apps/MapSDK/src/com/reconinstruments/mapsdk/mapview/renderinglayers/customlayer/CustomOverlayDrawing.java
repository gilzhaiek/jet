...
public class CustomOverlayDrawing extends CustomWorldObjectDrawing{
// constants
	private final static String TAG = "CustomOverlayDrawing";
...
// members
	...
	public CustomOverlayDrawing(String _overlayID, ArrayList<PointXY> _nodes, int _color,  int _alpha, World2DrawingTransformer _world2DrawingTransformer) {
		super(_overlayID, CustomObjectTypes.TRAIL);
...
//		mPaint.setStrokeWidth(_lineWidthInM/World2DrawingTransformer.DISTANCE_PER_PIXEL);
