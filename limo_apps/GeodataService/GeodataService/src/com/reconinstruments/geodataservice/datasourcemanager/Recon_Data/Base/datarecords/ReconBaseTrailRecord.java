...
public class ReconBaseTrailRecord extends ReconBaseDataRecord 
{
	private final static String TAG = "ReconBaseTrailRecord";
	...
	public ReconBaseTrailRecord(ReconBaseDataSource.BaseDataTypes type, String name, ArrayList<PointXY> nodes, int speedLimit, boolean isOneWay, boolean isUserLocationDependent) {
