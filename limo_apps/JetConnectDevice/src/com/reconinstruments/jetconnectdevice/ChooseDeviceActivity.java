...
/**
 * <code>ChooseDeviceActivity</code> decides which device should connect
 */
public class ChooseDeviceActivity extends CarouselItemHostActivity {
    ...
    private static final String HAS_CONNECTED_BEFORE = ConnectSmartphoneActivity.HAS_CONNECTED_BEFORE;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBodyTV.setText(R.string.desc_choose_device);
    ...
    protected List<Fragment> getFragments() {
        ...
        fList.add(new ConnectSmartphoneFragment(R.layout.title_body_carousel_item, "iPhone", 0, 0));
        fList.add(new ConnectSmartphoneFragment(R.layout.title_body_carousel_item, "Android", 0, 1));
        return fList;
    }
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_DPAD_CENTER:
                ...
                if (mPager.getCurrentItem() == 0) {
                    intent = new Intent(this, WaitingForIphoneActivity.class);
                }else{
                    intent = new Intent(this, WaitingForAndroidActivity.class);
                }
    ...
    public void onBackPressed() {
        if(mFrom != FROM_NORMAL){
            ...
            if(firstTimeConnecting){
	            Intent intent = new Intent(this, ConnectSmartphoneActivity.class);
		        CommonUtils.launchParent(this,intent,false);
            }
            else {
            	finish();
