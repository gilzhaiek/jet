...
public class CRC16
{
	...
	protected static final int	crc16tab[]	= { 0x0000, 0xC0C1, 0xC181, 0x0140, 0xC301, 0x03C0, 0x0280, 0xC241, 0xC601,
	...
	public static short checksum(byte[] value)
	{
		int val = 0;
		int N = value.length;
		...
		for(int i = 0; i < N; i++)
		{
			val = (val >>> 8) ^ crc16tab[(val ^ value[i]) & 0xff];
		}
