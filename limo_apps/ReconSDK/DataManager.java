...
public class DataManager
{
    ...
    // Messenger for communicating with Transcend Service
    private Messenger    mService = null;     
    
    // internal export -- Transcend Service  Link Up/Down
    ...
    /**
     * Class for interacting with the main interface Transcend Service
     */
    private ServiceConnection mConnection = new ServiceConnection()
    {
	    public void onServiceConnected(ComponentName className, IBinder service)
	    {
		   Log.d(TAG, "Transcend Service connected");
