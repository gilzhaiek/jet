...
import com.reconinstruments.camera.OnClickAttr;
...
import com.reconinstruments.camera.preference.CameraPreference;
...
import com.reconinstruments.camera.util.Thumbnail;
...
public class VideoModule implements CameraModule,
    ...
    //private int mFrameRatePreview = 10; //Frames per second for preview
    private int mFrameRateRecording = 30; //Frames per second for recording
    // module fields
    ...
    @Override
    public void init(CameraActivity activity, View root, boolean showInstructions) {
        mActivity = activity;
        mUI = new VideoUI(activity, this, root, showInstructions);
    ...
    /**
     * TODO will be used when snapshot need to be implemented.
     */
    ...
    private void readVideoPreferences() {
        ...
        if (videoQuality == null) {
            ...
            mPreferences.edit().putString(CameraSettings.KEY_VIDEO_QUALITY, videoQuality).commit();
        }
    ...
    private void getDesiredPreviewSize() {
        ...
        if (mParameters.getSupportedVideoSizes() == null) {
            ...
            Log.d(TAG, "Setting Video preview size... ");
    ...
    public void onResumeAfterSuper() {
        ...
        if (!mPreviewing) {
            ...
            //The init function already set the camera parameters, so remove the duplicated settings here.
        } else {
    ...
    private void startPreview() {
        ...
        SurfaceHolder surfaceTexture = mUI.getSurfaceHolder();
        ...
        try {
            mCameraDevice.setPreviewDisplay(surfaceTexture);
    ...
    private void onPreviewStarted() {
        // TODO put things to do when preview started
    	Log.d(TAG, ">>>>>>>>>>>> VideoModule.onPreviewStarted()!");
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (mPaused && !mActivity.isPreviewTimedOut()) {
            return true;
        }
    ...
    private void initializeRecorder() {
        ...
        long maxFileSize = mActivity.getStorageSpaceBytes() - StorageUtil.LOW_STORAGE_THRESHOLD_BYTES;
    ...
    private void generateVideoFilename(int outputFileFormat) {
        ...
        String path = StorageUtil.DIRECTORY + '/' + filename;
    ...
    private void startVideoRecording() {
        ...
        mActivity.hideGalleryIcon();

        mActivity.updateStorageSpaceAndHint();
        //setFrameRate(mFrameRateRecording);
        ...
        try {
            if (mLedMgr != null) mLedMgr.contBlinkPowerLED(HUDLedManager.BRIGHTNESS_NORMAL, 500, 500, true);
    ...
    private boolean stopVideoRecording() {
        ...
        if (mMediaRecorderRecording) {
            ...
            try {
                if (mLedMgr != null) mLedMgr.contBlinkPowerLED(0, 0, 0, false);
        ...
        // recording stopped, call this to kickstart the idle counter in CameraActivity again
        mUI.hidePreviewTimeoutScreen();
        ...
        //setFrameRate(mFrameRatePreview);
        return fail;
    }
    ...
    private void setFrameRate(int framerate) {
        if(DEBUG)
            Log.v(TAG, "Change framerate from " + mProfile.videoFrameRate + " to "+ framerate);
        mProfile.videoFrameRate = framerate;
        mParameters.setPreviewFpsRange(framerate*1000,framerate*1000);
    ...
    private void setCameraParameters() {
        ...
        */
        ...
        if(DEBUG) {
            ...
            Log.v(TAG, "Cammera supported FPS range");
    ...
    public void togglePreviewTimeoutScreen(boolean showTimeoutScreen){
        if(showTimeoutScreen){
            // if currently recording, don't kill camera preview, do nothing instead.
            // When video recording stops, the Activity will resume counting
            if(!isRecording()) mUI.showPreviewTimeoutScreen();
        }
