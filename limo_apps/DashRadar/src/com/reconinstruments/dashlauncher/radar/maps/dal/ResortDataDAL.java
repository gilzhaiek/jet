...
import com.reconinstruments.dashlauncher.radar.maps.dbf.DbfContent;
import com.reconinstruments.dashlauncher.radar.maps.dbf.DbfRecord;
import com.reconinstruments.dashlauncher.radar.maps.dbf.DbfTools;
...
import com.reconinstruments.dashlauncher.radar.maps.shp.ShpContent;
import com.reconinstruments.dashlauncher.radar.maps.shp.ShpPoint;
import com.reconinstruments.dashlauncher.radar.maps.shp.ShpPolygon;
import com.reconinstruments.dashlauncher.radar.maps.shp.ShpPolyline;
import com.reconinstruments.dashlauncher.radar.maps.shp.ShpRecord;
import com.reconinstruments.dashlauncher.radar.maps.shp.ShpTools;
...
public class ResortDataDAL {
	...
	public void LoadResortData(AsyncTask<?, ?, ?> asyncTask, ResortData resortData, ResortInfo resortInfo) throws IOException {
		...
		try{
			...
			if( mapDataZipFile.exists() == false) {
				Log.e(TAG, CommonSettings.GetMapDataZipFileName() + " Doesn't Exists");
				throw new Exception(CommonSettings.GetMapDataZipFileName() + " Doesn't Exists");
			}
	...
	protected boolean IsInAmericas(ShpRecord record){
		...
		{                
			...
			case ShpType.SHAPE_POLYGON: tmpLongitude = ((ShpPolygon)record.shape).box.topLeft.x; break;
		}
