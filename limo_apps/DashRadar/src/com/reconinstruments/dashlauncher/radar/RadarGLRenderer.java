...
public class RadarGLRenderer implements GLSurfaceView.Renderer {
	...
	// Settings
	protected final static float BG_RED_COLOR	= 0x69/256.0f;  // 
	protected final static float BG_GREEN_COLOR	= 0xA1/256.0f;  // 
	protected final static float BG_BLUE_COLOR	= 0xEE/256.0f;  // 
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		...
		gl.glClearColor(BG_RED_COLOR, BG_GREEN_COLOR, BG_BLUE_COLOR, 1.0f);
