...
public class SmartphoneConnector 
{
	...
	public SmartphoneConnector(SmartphoneInterface context){
		...
		getActivity().registerReceiver(phoneConnectionReceiver, new IntentFilter(BTCommon.MSG_STATE_UPDATED));
...
//		return (HUDServiceHelper.getInstance(DashLauncherApp.getInstance().getApplicationContext()).isConnected(DashLauncherApp.getInstance().getApplicationContext())||DashLauncherApp.getInstance().isIPhoneConnected());
