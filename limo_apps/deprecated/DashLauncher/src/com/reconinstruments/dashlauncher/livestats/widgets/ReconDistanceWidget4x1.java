...
public class ReconDistanceWidget4x1 extends ReconDashboardWidget {
	
	private TextView fieldTextView;
	
	public ReconDistanceWidget4x1(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		LayoutInflater infl = LayoutInflater.from(context);
        View myView = infl.inflate(R.layout.livestats_widget_distance_4x1, null);
        this.addView(myView);
        
        prepareInsideViews();
	}
	public ReconDistanceWidget4x1(Context context, AttributeSet attrs) {
		super(context, attrs);
		LayoutInflater infl = LayoutInflater.from(context);
        View myView = infl.inflate(R.layout.livestats_widget_distance_4x1, null);
        this.addView(myView);
	...
	public ReconDistanceWidget4x1(Context context) {
		super(context);
	...
	public void prepareInsideViews() {
		fieldTextView = (TextView) findViewById(R.id.dist_field);
