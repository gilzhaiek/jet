	...
	static public final String UNIT_SETTING = "unitSetting";
	 ...
	 static protected int getUnitsWrite( Context context )
	 {
		 ...
		 catch( Settings.SettingNotFoundException e )
		 {
			 ...
			 //let's create the system setting, and set the default unit 
			 //to be Metric			
			 Settings.System.putInt( context.getContentResolver(), RECON_UNIT_SETTING, RECON_UNITS_METRIC  );
			 return RECON_UNITS_METRIC;
	 ...
	 {
		 Settings.System.putInt( context.getContentResolver(), RECON_UNIT_SETTING, setting == RECON_UNITS_METRIC ? RECON_UNITS_METRIC : RECON_UNITS_IMPERIAL );		 
	 }	
}