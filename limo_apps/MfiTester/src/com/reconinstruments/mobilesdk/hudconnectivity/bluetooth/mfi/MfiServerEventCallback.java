...
public class MfiServerEventCallback implements ServerEventCallback {
	private static final String TAG = "MfiServerEventCallback";
	private Activity mActivity;

	public MfiServerEventCallback(Activity activity) {
		mActivity = activity;
	}
