...
public class ReconPackageRecorder {
    ...
    public static final String PACKAGES_XML_PATH  = "ReconApps/Installer/installed_packages.xml";
    public static final File PACKAGES_XML_FILE = new File(Environment.getExternalStorageDirectory()+"/ReconApps/Installer/installed_packages.xml");
