...
import com.reconinstruments.stats.tabs.*;
...
public class StatsTabView extends TabView{
	...
	Context mContext;
	ArrayList<Bundle> runsList = null;
	...
	public void setViewData(Bundle data) {
		...
		runsList = data.getBundle("RUN_BUNDLE").getParcelableArrayList("Runs");
	}
	
	public boolean onSelectUp(View srcView) {
		if(mSelectedTabIdx == 0) {
			Log.d("JumpTabView", "Launch Run History");
