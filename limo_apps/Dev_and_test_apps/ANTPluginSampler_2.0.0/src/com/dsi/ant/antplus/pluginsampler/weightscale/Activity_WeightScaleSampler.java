                                    ...
                                    { 
                                        ...
                                        switch(status)
                                        {
                                            ...
                                            case UNRECOGNIZED:
                                                ...
                                                Toast.makeText(Activity_WeightScaleSampler.this, "Failed: UNRECOGNIZED. Upgrade Required?", Toast.LENGTH_SHORT).show();
                                                break;
                                            default:
        ...
        AntPlusWeightScalePcc.requestAccess(this, this,
            ...
            private void subscribeToEvents()
            {
                ...
                wgtPcc.subscribeBodyWeightBroadcastEvent(new IBodyWeightBroadcastReceiver()
                        {                            
                            @Override
                            public void onNewBodyWeightBroadcast(final long estTimestamp, EnumSet<EventFlag> eventFlags,
