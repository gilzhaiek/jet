...
public class OSMAreaRecord extends OSMDataRecord 
{
	private final static String TAG = "OSMAreaRecord";
	
	public ArrayList<PointXY>	mPolylineNodes;
	public RectXY				mBoundingBox;
	public PointXY				mCentroid;
	
	public OSMAreaRecord(TileCompressor.OSMBaseDataTypes type, String name, ArrayList<PointXY> nodes, boolean isUserLocationDependent) {
