 ...
 */
public class DatasetBoundingBox2Filter implements DatasetSinkSource {
	private Sink sink;
	private double left;
	 ...
	 *            filtered area.
	 */
	public DatasetBoundingBox2Filter(double left, double right, double top, double bottom, boolean completeWays) {
		this.left = left;
		this.right = right;
		this.top = top;
		this.bottom = bottom;
	...
	public void process(Dataset dataset) {
		...
		bboxData = datasetReader.iterateBoundingBox2(left, right, top, bottom, completeWays);
		try {
