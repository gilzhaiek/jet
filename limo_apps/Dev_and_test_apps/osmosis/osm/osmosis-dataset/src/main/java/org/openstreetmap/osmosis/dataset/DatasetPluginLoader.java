...
import org.openstreetmap.osmosis.dataset.v0_6.DatasetBoundingBox2FilterFactory;
...
import org.openstreetmap.osmosis.dataset.v0_6.QueryNodeDatasetFactory;
import org.openstreetmap.osmosis.dataset.v0_6.QueryWayDatasetFactory;
import org.openstreetmap.osmosis.dataset.v0_6.QueryRelationDatasetFactory;
...
public class DatasetPluginLoader implements PluginLoader {
	...
	public Map<String, TaskManagerFactory> loadTaskFactories() {
		...
		factoryMap.put("dataset-bounding-box2", new DatasetBoundingBox2FilterFactory());
		factoryMap.put("dbb2", new DatasetBoundingBox2FilterFactory());
		
		factoryMap.put("dataset-node", new QueryNodeDatasetFactory());
		factoryMap.put("dataset-way", new QueryWayDatasetFactory());
		factoryMap.put("dataset-relation", new QueryRelationDatasetFactory());
		...
		factoryMap.put("dataset-bounding-box2-0.6", new DatasetBoundingBox2FilterFactory());
		
		factoryMap.put("dataset-node-0.6", new QueryNodeDatasetFactory());
		factoryMap.put("dataset-way-0.6", new QueryWayDatasetFactory());
		factoryMap.put("dataset-relation-0.6", new QueryRelationDatasetFactory());
