...
public class BestHeightTabPage extends ReconTabPage {
	public BestHeightTabPage(Context context, Drawable iconRegular,
			Drawable iconSelected, Drawable iconFocused, TabView hostView) {
		super(context, iconRegular, iconSelected, iconFocused, hostView, "BEST HEIGHT");
