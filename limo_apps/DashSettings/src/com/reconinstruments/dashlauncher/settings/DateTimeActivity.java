...
//	private static final int POS_MANUAL		= 3;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (ReconSettingsUtil.getSyncTimeWithSmartPhone(getBaseContext())  && BTPropertyReader.getBTConnectionState(DateTimeActivity.this) == 2 ) {
			...
			public void onItemClick(AdapterView<?> adapterView, View view,
				...
				case POS_AUTO:
				    if(BTPropertyReader.getBTConnectionState(DateTimeActivity.this) == 2){
	                    if (!ReconSettingsUtil.getSyncTimeWithSmartPhone(getBaseContext())) { // gps local time is on, means syncing time with smartphone
	                        ReconSettingsUtil.setSyncTimeWithSmartPhone(getBaseContext(), true);
	                        ...
	                        ReconSettingsUtil.setSyncTimeWithSmartPhone(getBaseContext(), false);
		    ...
		    if(intent.getAction().equals("HUD_STATE_CHANGED")){
				...
				if (!intent.hasExtra("message")) {
					...
					try{
						...
						if(ReconSettingsUtil.getSyncTimeWithSmartPhone(context)){
