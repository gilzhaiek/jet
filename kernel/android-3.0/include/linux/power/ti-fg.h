...
// The formula is Voltage+((Current+NORM_2_C_VAL)*NORM_2_C_DISCH/1000000)
#ifdef CONFIG_JET_SUN
#define NORM_2_C_DISCH		-375
#define NORM_2_C_VAL		100000
#define SW_LOSS_MV		0
#else //CONFIG_JET_SNOW
#define NORM_2_C_DISCH		-375
#define NORM_2_C_VAL		130000
#define SW_LOSS_MV		25
#endif
// Current is in uA voltage is mV
#define NORM_VOLTAGE(_voltage_mV,_current_uA)	(_voltage_mV+((_current_uA+NORM_2_C_VAL)*NORM_2_C_DISCH/1000000)+SW_LOSS_MV)

#define MAX_VOLTAGE_CHANGE_PER	2
...
#ifdef CONFIG_JET_SUN
#define FG_CURRENT_CHECK -500 //mA
#else //CONFIG_JET_SNOW
...
//maybe only for Snow2
	...
	unsigned char seq_cc_temperature;
...
#else
static inline void fg_init(struct cell_state *cell, short voltage, short temperature)
{
}
