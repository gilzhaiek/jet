 ...
 * \return 0 for success other negative numbers for failure
 */
...
static struct attribute* jet_sensors_attributes[] = 
{
	...
	&dev_attr_mag_temp_enable.attr,
	&dev_attr_mag_temp.attr,
#endif
	NULL
};
						   ...
						   const struct i2c_device_id *id)
{
	...
	dev_set_drvdata(jet_sensors->dev.this_device, jet_sensors);
