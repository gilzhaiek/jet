...
import com.reconinstruments.hudconnectivitylib.IHUDConnectivity.NetworkEvent;
import com.reconinstruments.hudconnectivitylib.bluetooth.HUDBTBaseService.OutputStreamContainer;
import com.reconinstruments.hudconnectivitylib.bluetooth.HUDBTHeaderFactory;
import com.reconinstruments.hudconnectivitylib.bluetooth.HUDBTMessage;
import com.reconinstruments.hudconnectivitylib.bluetooth.HUDBTMessageCollectionManager;
import com.reconinstruments.hudconnectivitylib.bluetooth.IHUDBTConsumer;
...
public class HUDHttpBTConnection extends BroadcastReceiver implements IHUDBTConsumer {
    ...
    @Override public void onReceive(Context context, Intent intent) {
        ...
        try {
            ...
            Log.e(TAG, "onReceive: Couldn't updateLocalWebConnection", e);
        }
    }
