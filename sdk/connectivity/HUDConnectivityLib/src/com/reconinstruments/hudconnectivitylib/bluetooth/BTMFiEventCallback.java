...
public class BTMFiEventCallback implements ServerEventCallback, ClientEventCallback {
    ...
    public static final int FROM_HUD_CONNECTED_EVENT = 1;
    public static final int FROM_IPHONE_CONNECTED_EVENT = 2;
    public static final int DISCONNECTED_EVENT = 3;
    public static final int SESSION_OPEN_REQUEST_EVENT = 4;
    public static final int SESSION_CLOSE_EVENT = 5;
