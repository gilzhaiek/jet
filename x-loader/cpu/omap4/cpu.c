...
int cpu_init (void)
{
	...
	__raw_writel(RECON_DEVICE_ID, 0x4A326100);
...
static void scale_vcore_omap4430(unsigned int rev)
{
	...
	omap_vc_bypass_send_value(TWL6032_SRI2C_SLAVE_ADDR, TWL6032_SRI2C_REG_ADDR_SMPS2, 0x22);

	/* vdd_mpu - SMPS 1 - OPP100 - 1.2027V */
	omap_vc_bypass_send_value(TWL6032_SRI2C_SLAVE_ADDR, TWL6032_SRI2C_REG_ADDR_SMPS1, 0x28);

	/* vdd_iva - SMPS 5 - OPP50 - 0.950V */
	omap_vc_bypass_send_value(TWL6032_SRI2C_SLAVE_ADDR, TWL6032_SRI2C_REG_ADDR_SMPS5, 0x14);
#else
	/* vdd_core - VCORE 3 - OPP100 - ES2+: 1.127 */
	omap_vc_bypass_send_value(TWL6030_SRI2C_SLAVE_ADDR, TWL6030_SRI2C_REG_ADDR_VCORE3, 0x22);

	/* vdd_mpu - VCORE 1 - OPP100 - ES2+: 1.2027 */
	omap_vc_bypass_send_value(TWL6030_SRI2C_SLAVE_ADDR, TWL6030_SRI2C_REG_ADDR_VCORE1, 0x28);

	/* vdd_iva - VCORE 2 - OPP50 - ES2+: 0.950V */
	omap_vc_bypass_send_value(TWL6030_SRI2C_SLAVE_ADDR, TWL6030_SRI2C_REG_ADDR_VCORE2, 0x14);
#endif
}
