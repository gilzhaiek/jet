...
#define CONFIG_4430JET          1    /* working with JET */
#define CONFIG_FASTBOOT         1    /* Using fastboot interface */
#define CONFIG_SET_FLASH_SLOT   1   /* Set Flash slot to SD or EMMC */

//#define CFG_ALT_MEMTEST 1  /*Set real memory test*/
...
#define CFG_ENV_OFFSET		0x240000
...
#define CONFIG_COMMANDS          ((CFG_CMD_I2C | CONFIG_CMD_DFL | \
    ...
    (~(CFG_CMD_AUTOSCRIPT|NET_CMDS) | CFG_CMD_NAND | CFG_CMD_ONENAND))
...
/*Set 1 for jet test command*/
#define CONFIG_JET_TEST       0
...
//#define CONFIG_BOOTARGS "console=ttyO2,115200n8 init=/init androidboot.console=ttyO2 androidboot.serialno=${RID} "
/*
 ...
 */
#ifdef JET_V2_CONFIG
#define V_PROMPT                 "jet V2# "
#else
#define V_PROMPT                 "jet V1# "
#endif
...
#define	 MV1(OFFSET, VALUE) __raw_writew((VALUE), OMAP44XX_WKUP_CTRL_BASE + (OFFSET));
