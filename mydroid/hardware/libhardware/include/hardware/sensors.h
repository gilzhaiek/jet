...
struct sensors_poll_device_t {
    ...
    /**
      * Recon Extension: Retrieve Cache of Sensor Data
      *
      *@return the number of cached sensor events, or -errno in case of an error
    */
    int (*getCache)(struct sensors_poll_device_t* dev, 
           int handle, sensors_event_t* data, int count);
};
