...
if [ "$PLATFORM_VERSION" = "1.6" ]; then
        ...
        echo "UNKNOWN - Aborting (currently supporting Donut or Eclair(2.0 & 2.1) only)"
		exit
fi
...
mkdir -p var/run
cp $ANDROID_HOME/mydroid/external/mcp/MCP_Common/Platform/scripts/android_zoom2/pan/*.sh btips/TI/scripts/
cp $ANDROID_HOME/mydroid/external/mcp/MCP_Common/Platform/scripts/android_zoom2/pan/dnsmasq system/bin/
cp $ANDROID_HOME/mydroid/external/mcp/MCP_Common/Platform/scripts/android_zoom2/pan/tcpdump system/bin/
cp $ANDROID_HOME/mydroid/external/mcp/MCP_Common/Platform/scripts/android_zoom2/pan/20-dns.conf system/etc/dhcpcd/dhcpcd-hooks/
cp $ANDROID_HOME/mydroid/external/mcp/MCP_Common/Platform/scripts/android_zoom2/pan/dhcpcd.conf system/etc/dhcpcd/
cp $ANDROID_HOME/mydroid/external/mcp/MCP_Common/Platform/scripts/android_zoom2/pan/dnsmasq_gn.conf system/etc/
cp $ANDROID_HOME/mydroid/external/mcp/MCP_Common/Platform/scripts/android_zoom2/pan/dnsmasq_nap.conf system/etc/
...
cp $ANDROID_HOME/mydroid/external/mcp/MCP_Common/Platform/init_script/android_zoom2/* btips/TI/BTInitScript/
cp btips/TI/BTInitScript/tiinit_10.4.27.bts system/etc/firmware/TIInit_10.4.27.bts
cp btips/TI/BTInitScript/tiinit_7.2.31.bts system/etc/firmware/TIInit_7.2.31.bts
cp btips/TI/BTInitScript/tiinit_10.5.20.bts system/etc/firmware/TIInit_10.5.20.bts
