...
ifeq ($(BTIPS_DEBUG),1)
    LOCAL_CFLAGS+= -g -O0 -DMCP_LOGD -DMCP_LOGV -DMCP_LOGI
    LOCAL_LDFLAGS+= -g
else
...
LOCAL_SRC_FILES:= \
                frame/mcp_config_parser.c \
                frame/mcp_config_reader.c \
                frame/mcp_endian.c \
                frame/mcpf_main.c \
                frame/mcpf_queue.c \
                frame/mcpf_report.c \
                ...
                frame/mcp_gensm.c \
                frame/mcp_pool.c \
                frame/mcp_rom_scripts_db.c \
                frame/mcp_utils_dl_list.c \
                frame/mcp_utils.c \
                frame/mcp_log_common.c \
                frame/mcp_unicode.c \
                frame/mcpf_msg.c \
                frame/mcpf_services.c \
                frame/mcpf_sll.c \
                frame/mcpf_time.c \
                ...
                Platform/init_script/android_zoom/mcp_rom_scripts.c
...
LOCAL_C_INCLUDES := \
		...
		$(LOCAL_PATH)/Platform/os/LINUX \
		$(LOCAL_PATH)/Platform/os/LINUX/inc \
