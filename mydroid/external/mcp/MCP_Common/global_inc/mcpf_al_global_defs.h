 ...
 *
 * FileName         :   mcpf_al_global_defs.h
 *
 * Description      :   This file contains all the structure declaration used
 *                      to used for IPC messaging between Adaptation layer and MCPF
 *
