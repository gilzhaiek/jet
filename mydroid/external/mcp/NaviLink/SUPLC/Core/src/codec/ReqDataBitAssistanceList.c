...
#include "codec/ReqDataBitAssistanceList.h"
...
static asn_SET_OF_specifics_t asn_SPC_ganssDataBitSatList_specs_4 = {
	sizeof(struct ganssDataBitSatList),
	offsetof(struct ganssDataBitSatList, _asn_ctx),
	0,	// XER encoding is XMLDelimitedItemList 
};

static asn_per_constraints_t asn_PER_ganssDataBitSatList_constr_4 = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
asn_TYPE_descriptor_t asn_DEF_ganssDataBitSatList_4 = {
	...
	&asn_PER_ganssDataBitSatList_constr_4,
...
static asn_TYPE_tag2member_t asn_MAP_ReqDataBitAssistanceList_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, // gnssSignals at 128 
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, // ganssDataBitInterval at 129 
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } // ganssDataBitSatList at 130 
};
*/
