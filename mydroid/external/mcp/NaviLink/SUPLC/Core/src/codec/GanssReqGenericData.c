...
#include "codec/GanssReqGenericData.h"
...
static asn_per_constraints_t asn_PER_memb_ganssTimeModels_constr_7 = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
static asn_TYPE_member_t asn_MBR_GanssReqGenericData_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct GanssReqGenericData, ganssDifferentialCorrection),
	...
	{ ATF_POINTER, 3, offsetof(struct GanssReqGenericData, ganssAlmanac),
	...
	{ ATF_POINTER, 1, offsetof(struct GanssReqGenericData, ganssTimeModels),
		...
		&asn_PER_memb_ganssTimeModels_constr_7,
		0,
		"ganssTimeModels"
		},
...
static int asn_MAP_GanssReqGenericData_oms_1[] = { 2, 3, 4, 5, 7, 9, 10 };
/*
...
static asn_TYPE_tag2member_t asn_MAP_GanssReqGenericData_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, // ganssId at 44 
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, // ganssRealTimeIntegrity at 45 
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, // ganssDifferentialCorrection at 46 
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, // ganssAlmanac at 47 
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, // ganssNavigationModelData at 48 
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, // ganssTimeModels at 49 
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, // ganssReferenceMeasurementInfo at 50 
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 }, // ganssDataBits at 51 
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 }, // ganssUTCModel at 52 
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 }, // ganssExtendedEphemeris at 53 
    { (ASN_TAG_CLASS_CONTEXT | (10 << 2)), 10, 0, 0 } // ganssExtendedEphemerisCheck at 54 
};
*/
