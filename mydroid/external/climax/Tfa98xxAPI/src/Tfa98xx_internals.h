...
/* SYSTEM CONTROL bits */
#define TFA98XX_SYSCTRL_POWERDOWN    (1<<0)
#define TFA98XX_SYSCTRL_RESETI2C     (1<<1)
#define TFA98XX_SYSCTRL_ENBL_AMP     (1<<3)
#define TFA98XX_SYSCTRL_CONFIGURED   (1<<5)
#define TFA98XX_SYSCTRL_SEL_ENBL_AMP (1<<6)
