...
#define TFA_I2CDEVICE		"/dev/i2c-3"		// Panda = 4 device driver interface special file
//#define TFA_I2CDEVICE		"/dev/ttyUSB0"		// Panda = 4 device driver interface special file
