/*
  ...
  /home/siji/bin/gengetopt -i src/cli/climax_cmdline.ggo --output-dir=src/cli 
...
const char *gengetopt_args_info_full_help[] = {
  ...
  "  -b, --verbose                 Enable verbose printing",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->calshow_help = gengetopt_args_info_full_help[10] ;
  args_info->init_help = gengetopt_args_info_full_help[11] ;
  args_info->reset_help = gengetopt_args_info_full_help[12] ;
  args_info->params_help = gengetopt_args_info_full_help[13] ;
  args_info->params_min = 0;
  args_info->params_max = 0;
  args_info->profile_help = gengetopt_args_info_full_help[14] ;
  args_info->currentprof_help = gengetopt_args_info_full_help[15] ;
  args_info->volume_help = gengetopt_args_info_full_help[16] ;
  args_info->versions_help = gengetopt_args_info_full_help[18] ;
  args_info->register_help = gengetopt_args_info_full_help[19] ;
  args_info->register_min = 0;
  args_info->register_max = 0;
  args_info->regwrite_help = gengetopt_args_info_full_help[20] ;
  args_info->regwrite_min = 0;
  args_info->regwrite_max = 0;
  args_info->dump_help = gengetopt_args_info_full_help[21] ;
  args_info->pin_help = gengetopt_args_info_full_help[22] ;
  args_info->diag_help = gengetopt_args_info_full_help[23] ;
  args_info->dumpmodel_help = gengetopt_args_info_full_help[24] ;
  args_info->dsp_help = gengetopt_args_info_full_help[25] ;
  args_info->tcoef_help = gengetopt_args_info_full_help[26] ;
  args_info->record_help = gengetopt_args_info_full_help[28] ;
  args_info->recordStereo_help = gengetopt_args_info_full_help[29] ;
  args_info->count_help = gengetopt_args_info_full_help[30] ;
  args_info->output_help = gengetopt_args_info_full_help[31] ;
  args_info->load_help = gengetopt_args_info_full_help[33] ;
  args_info->save_help = gengetopt_args_info_full_help[34] ;
  args_info->server_help = gengetopt_args_info_full_help[35] ;
  args_info->slave_help = gengetopt_args_info_full_help[36] ;
  args_info->loop_help = gengetopt_args_info_full_help[37] ;
  args_info->verbose_help = gengetopt_args_info_full_help[38] ;
  args_info->trace_help = gengetopt_args_info_full_help[39] ;
  args_info->quiet_help = gengetopt_args_info_full_help[40] ;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'L':	/* loop the operation [0=forever].  */
          ...
          break;
        case 'b':	/* Enable verbose printing.  */
