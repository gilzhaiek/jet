...
#define COLD ((1 << 11) & statusReg)
    if (tfaHardwarePoweredDown | COLD) {
        err = tfa98xxInit(handlesIn[idx]);// TODO check if too fast
        usleep(1000);
        /* check if we really have a stable clock */
...
static Tfa98xx_Error_t tfaInitSettings(Tfa98xx_handle_t handle)
{
    ...
    err = Tfa98xx_SetSampleRate(handle, 48000); //TODO get this from profile
    PrintAssert(err);
...
int tfa98xxInit( Tfa98xx_handle_t handle )
{
    ...
    //TODO  usleep(10000);  // wait for 10ms
 ...
 */
static Tfa98xx_Error_t waitCalibration(Tfa98xx_handle_t handle, float *pRe25)
{
   Tfa98xx_Error_t err;
   int calibrateDone = 0;
   int i = 0;
...
int tfa98xxWaitCalibration(Tfa98xx_handle_t *handlesIn) 
{
   ...
   if (handlesIn[idx] >= 0) 
   {
      err = waitCalibration(handlesIn[idx], &re0);
   }
...
static Tfa98xx_Error_t resetMtpEx(Tfa98xx_handle_t handle)
{
	Tfa98xx_Error_t err;
  unsigned short mtp;
	unsigned short status;
...
static int firstTimeCalibration(Tfa98xx_handle_t *handlesIn, int once)
{
   ...
   printf("tCoef = %1.5f\n", tCoef);
   if ( tCoef < 0.005f ) /* still contains the tCoef, not yet tCoefA */
   {
	  if(checkMTPEX(handlesIn[idx]) == 0)
      {
         printf("still tCoef in speaker file, special calibration needed\n");

         err = calculateSpeakertCoefA(handlesIn[idx], tfaParams.speakerBuffer);
         if (err != Tfa98xx_Error_Ok)
         {
            return err;
         }

         resetMtpEx(handlesIn[idx]);
...
int nxpTfa98xxCalibrationStereo(Tfa98xx_handle_t *handlesIn, int once)
{
   ...
   for (i = 0; i < 2; i++)
   {
      ...
      if ( tCoef < 0.005f ) /* still contains the tCoef, not yet tCoefA */
      {
	      if(checkMTPEX(handlesIn[i]) == 0)
         {
            ...
            err = calculateSpeakertCoefA(handlesIn[i], tfaParams.speakerBuffer);
            if (err != Tfa98xx_Error_Ok)
            {
               return err;
            };

            resetMtpEx(handlesIn[i]);
            /* force recalibration now with correct tCoefA */
		      muteAmplifier(handlesIn[i]); /* clean shutdown to avoid plop */
   ...
   for (i = 0; i < 2; i++)
   {
      ...
      waitCalibration(handlesIn[i], &re25);
      printf("Calibration value is %2.2f ohm\n", re25);
...
int tfa98xxCalibration(Tfa98xx_handle_t *handlesIn, int once ) 
{
   ...
   if ( Tfa98xx_Error_Ok == err ) 
   {
      err = firstTimeCalibration(handlesIn, once);
	  PrintAssert(err);
   }
...
nxpTfa98xx_Error_t nxpTfa98xxVersions( Tfa98xx_handle_t *handlesIn, char *strings, int maxlength )
{
    ...
    sprintf(str, "Tfa98xx API rev: 1.2.0.2\n");
#else
   ...
   */
   switch ( params )
   {
      ...
      case tfa_config_params:
         ...
         return c;
      case tfa_preset_params:
         c = Tfa98xx_DspReadPreset( handlesIn[idx], 
   ...
   */
   switch ( params )
   {
      ...
      case tfa_speaker_params:
         ...
         c = fread( (void*)&tfaParams.speakerBuffer, TFA98XX_SPEAKERPARAMETER_LENGTH , 1, f );
         fclose(f);
      ...
      case tfa_config_params:
         ...
         c = fread( (void*)&tfaParams.configBuffer, TFA98XX_CONFIG_LENGTH , 1, f );
         fclose(f);
 ...
 * Opening the device
 */
nxpTfa98xx_Error_t nxpTfa98xxCalibrate (Tfa98xx_handle_t *handlesIn   )
{
   nxpTfa98xx_Error_t err = nxpTfa98xx_Error_Fail;

   err = (nxpTfa98xx_Error_t) tfa98xxCalibration(handlesIn, 0);
...
unsigned char devkit_parms[] = {
  0x52, 0x09, 0x00, 0x00, 0x12, 0x22, 0x10, 0x73, 0x33, 0x33, 0x03, 0x00,
  ...
  ,
  ...
  0x01, 0x05, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x0f, 0xff, 0x50, 0x00,
  0x00, 0x00, 0x10, 0x00, 0x08, 0x00, 0x00, 0x00, 0x19, 0x9a, 0x00, 0x00,
