...
#define TFA_I2CDEVICE		"/dev/tfa98xx"		// Panda = 4 device driver interface special file
...
#define TFA_PROFILE0_I2SINPUT	(0)
#define TFA_PROFILE1_I2SINPUT	(1)		// i2s data in1
#define TFA_PROFILE2_I2SINPUT	(2)		//i2s data in2
#define TFA_PROFILE0_SAMPLERATE	(48000)
#define TFA_PROFILE1_SAMPLERATE	(48000)
#define TFA_PROFILE2_SAMPLERATE	(48000)
...
nxpTfa98xx_Error_t nxpTfa98xxCalibrate(Tfa98xx_handle_t *handlesIn); /* calibration */
...
/* calibration */
int tfa98xxCalibration(Tfa98xx_handle_t *handlesIn, int once );
