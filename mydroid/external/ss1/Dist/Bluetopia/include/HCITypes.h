...
#define HCI_LE_ADDRESS_TYPE_RANDOM                                      0x01
   ...
   /* feature (Version 4.2).                                            */
   /* * NOTE * The meaning of these two values is that the controller   */
   /*          shall generate the Resolvable Private Address (RPA) based*/
   /*          on the Local IRK found in the resolving list.  If the    */
   /*          resolving list contains no match the fallback is either  */
   /*          the public address of the controller or the random       */
   /*          address that has been set via the HCI LE Set Random      */
   /*          Address command.  These values will not be used in any   */
   /*          event sent by the controller.                            */
...
#define HCI_LE_PEER_ADDRESS_TYPE_STATIC_RANDOM_IDENTITY_ADDRESS         0x03
   ...
   /* The following constants represent the values that may be passed   */
   /* for the Peer Identity Address field to LE Controller Commands     */
   /* that take this parameter (Version 4.2).                           */
#define HCI_LE_PEER_IDENTITY_ADDRESS_TYPE_PUBLIC_ADDRESS                0x00
#define HCI_LE_PEER_IDENTITY_ADDRESS_TYPE_STATIC_RANDOM_ADDRESS         0x01
