...
int _AUDM_Connect_Audio_Stream(BD_ADDR_t RemoteDeviceAddress, AUD_Stream_Type_t StreamType, unsigned long StreamFlags);
   ...
   /* function returns zero if successful, or a negative return error   */
   /* code if there was an error.                                       */
int _AUDM_Disconnect_Audio_Stream(AUD_Stream_Type_t StreamType);
...
int _AUDM_Query_Audio_Stream_Connected(AUD_Stream_Type_t StreamType, BD_ADDR_t *RemoteDeviceAddress);
...
int _AUDM_Query_Audio_Stream_State(AUD_Stream_Type_t StreamType, AUD_Stream_State_t *StreamState);
...
int _AUDM_Query_Audio_Stream_Format(AUD_Stream_Type_t StreamType, AUD_Stream_Format_t *StreamFormat);

   /* The following function is provided to allow a mechanism for local */
   /* modules to start/suspend the specified Audio Stream.  This        */
   /* function returns zero if successful, or a negative return error   */
   /* code if there was an error.                                       */
int _AUDM_Change_Audio_Stream_State(AUD_Stream_Type_t StreamType, AUD_Stream_State_t StreamState);
...
int _AUDM_Change_Audio_Stream_Format(AUD_Stream_Type_t StreamType, AUD_Stream_Format_t *StreamFormat);
...
int _AUDM_Query_Audio_Stream_Configuration(AUD_Stream_Type_t StreamType, AUD_Stream_Configuration_t *StreamConfiguration);
...
int _AUDM_Change_Incoming_Connection_Flags(unsigned long ConnectionFlags);
   ...
   /*          immediately.                                             */
int _AUDM_Send_Encoded_Audio_Data(unsigned int AudioManagerDataEventCallbackID, unsigned int RawAudioDataFrameLength, unsigned char *RawAudioDataFrame);
...
int _AUDM_Send_RTP_Encoded_Audio_Data(unsigned int AudioManagerDataEventCallbackID, unsigned int RawAudioDataFrameLength, unsigned char *RawAudioDataFrame, unsigned long Flags, AUD_RTP_Header_Info_t *RTPHeaderInfo);
