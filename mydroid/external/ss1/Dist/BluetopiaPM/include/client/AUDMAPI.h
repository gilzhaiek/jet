...
BTPSAPI_DECLARATION int BTPSAPI AUDM_Connect_Audio_Stream(BD_ADDR_t RemoteDeviceAddress, AUD_Stream_Type_t StreamType, unsigned long StreamFlags, AUDM_Event_Callback_t CallbackFunction, void *CallbackParameter, unsigned int *ConnectionStatus);
   ...
   /* function returns zero if successful, or a negative return error   */
   /* code if there was an error.                                       */
BTPSAPI_DECLARATION int BTPSAPI AUDM_Disconnect_Audio_Stream(AUD_Stream_Type_t StreamType);

#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_AUDM_Disconnect_Audio_Stream_t)(AUD_Stream_Type_t StreamType);
#endif

   /* The following function is provided to allow a mechanism for local */
   /* modules to determine if the specified Audio Stream is currently   */
   /* connected.  This function returns a non-negative value if         */
   /* successful which represents the Connection State of specified     */
   /* Audio Stream.  The final parameter is optional, and if specified, */
   /* will hold the Bluetooth Device Address of the currently connected */
   /* device (if the Audio Stream is connected).  This function returns */
   /* a negative return error code if there was an error.               */
BTPSAPI_DECLARATION int BTPSAPI AUDM_Query_Audio_Stream_Connected(AUD_Stream_Type_t StreamType, BD_ADDR_t *RemoteDeviceAddress);

#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_AUDM_Query_Audio_Stream_Connected_t)(AUD_Stream_Type_t StreamType, BD_ADDR_t *RemoteDeviceAddress);
#endif
...
BTPSAPI_DECLARATION int BTPSAPI AUDM_Query_Audio_Stream_State(AUD_Stream_Type_t StreamType, AUD_Stream_State_t *StreamState);

#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_AUDM_Query_Audio_Stream_State_t)(AUD_Stream_Type_t StreamType, AUD_Stream_State_t *StreamState);
#endif
...
BTPSAPI_DECLARATION int BTPSAPI AUDM_Query_Audio_Stream_Format(AUD_Stream_Type_t StreamType, AUD_Stream_Format_t *StreamFormat);

#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_AUDM_Query_Audio_Stream_Format_t)(AUD_Stream_Type_t StreamType, AUD_Stream_Format_t *StreamFormat);
#endif
   ...
   /* function returns zero if successful, or a negative return error   */
   /* code if there was an error.                                       */
BTPSAPI_DECLARATION int BTPSAPI AUDM_Change_Audio_Stream_State(AUD_Stream_Type_t StreamType, AUD_Stream_State_t StreamState);

#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_AUDM_Change_Audio_Stream_State_t)(AUD_Stream_Type_t StreamType, AUD_Stream_State_t StreamState);
#endif
   ...
   /*          state is stopped.                                        */
BTPSAPI_DECLARATION int BTPSAPI AUDM_Change_Audio_Stream_Format(AUD_Stream_Type_t StreamType, AUD_Stream_Format_t *StreamFormat);

#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_AUDM_Change_Audio_Stream_Format_t)(AUD_Stream_Type_t StreamType, AUD_Stream_Format_t *StreamFormat);
#endif
...
BTPSAPI_DECLARATION int BTPSAPI AUDM_Query_Audio_Stream_Configuration(AUD_Stream_Type_t StreamType, AUD_Stream_Configuration_t *StreamConfiguration);

#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_AUDM_Query_Audio_Stream_Configuration_t)(AUD_Stream_Type_t StreamType, AUD_Stream_Configuration_t *StreamConfiguration);
#endif
...
BTPSAPI_DECLARATION int BTPSAPI AUDM_Change_Incoming_Connection_Flags(unsigned long ConnectionFlags);
   ...
   /*          immediately.                                             */
BTPSAPI_DECLARATION int BTPSAPI AUDM_Send_Encoded_Audio_Data(unsigned int AudioManagerDataEventCallbackID, unsigned int RawAudioDataFrameLength, unsigned char *RawAudioDataFrame);

#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_AUDM_Send_Encoded_Audio_Data_t)(unsigned int AudioManagerDataEventCallbackID, unsigned int RawAudioDataFrameLength, unsigned char *RawAudioDataFrame);
#endif
...
BTPSAPI_DECLARATION int BTPSAPI AUDM_Send_RTP_Encoded_Audio_Data(unsigned int AudioManagerDataEventCallbackID, unsigned int RawAudioDataFrameLength, unsigned char *RawAudioDataFrame, unsigned long Flags, AUD_RTP_Header_Info_t *RTPHeaderInfo);

#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_AUDM_Send_RTP_Encoded_Audio_Data_t)(unsigned int AudioManagerDataEventCallbackID, unsigned int RawAudioDataFrameLength, unsigned char *RawAudioDataFrame, unsigned long Flags, AUD_RTP_Header_Info_t *RTPHeaderInfo);
#endif
