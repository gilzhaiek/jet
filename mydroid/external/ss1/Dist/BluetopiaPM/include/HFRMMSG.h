...
#define HFRM_MESSAGE_FUNCTION_SEND_CURRENT_CALLS_LIST          0x00001408
...
#define HFRM_MESSAGE_FUNCTION_QUERY_CURRENT_CALLS_LIST_CFM     0x0001100A
...
#define HFRM_VOICE_TAG_RESPONSE_RESPONSE_SIZE                  (sizeof(HFRM_Voice_Tag_Response_Response_t))
   ...
   /* * NOTE * This structure is used with the                          */
   /*                                                                   */
   /*             HFRM_MESSAGE_FUNCTION_SEND_CURRENT_CALLS_LIST         */
   /*                                                                   */
   /*          Request message                                          */
   /*          (HFRM_Send_Current_Calls_List_Request_t structure) to    */
   ...
   /* * NOTE * This structure is used with the                          */
   /*                                                                   */
   /*             HFRM_MESSAGE_FUNCTION_QUERY_CURRENT_CALLS_LIST_CFM    */
   /*                                                                   */
   /*          Request message                                          */
...
typedef struct _tagHFRM_Call_List_List_Entry_t
{
   ...
   /*                                                                   */
   /*          Message Function ID.                                     */
typedef struct _tagHFRM_Send_Current_Calls_List_Request_t
{
   BTPM_Message_Header_t       MessageHeader;
   unsigned int                ControlEventsHandlerID;
   BD_ADDR_t                   RemoteDeviceAddress;
   unsigned int                NumberCallListEntries;
   HFRM_Call_List_List_Entry_t CallListEntryList[1];
} HFRM_Send_Current_Calls_List_Request_t;
   ...
   /* HFRM_Send_Current_Calls_List_Request_t structure and returns the  */
   /* total number of bytes required to hold the entire message.        */
#define HFRM_SEND_CURRENT_CALLS_LIST_REQUEST_SIZE(_x)          (STRUCTURE_OFFSET(HFRM_Send_Current_Calls_List_Request_t, CallListEntryList) + (unsigned int)((sizeof(HFRM_Call_List_List_Entry_t)*((unsigned int)(_x)))))
...
#define HFRM_VOICE_TAG_REQUEST_CONFIRMATION_MESSAGE_SIZE(_x)   (STRUCTURE_OFFSET(HFRM_Voice_Tag_Request_Confirmation_Message_t, PhoneNumber) + (unsigned int)((sizeof(char)*((unsigned int)(_x)))))
   ...
   /*                                                                   */
   /*          Message Function ID.                                     */
typedef struct _tagHFRM_Query_Current_Calls_List_Confirmation_Message_t
{
   BTPM_Message_Header_t       MessageHeader;
   BD_ADDR_t                   RemoteDeviceAddress;
   HFRM_Call_List_List_Entry_t CallListEntry;
} HFRM_Query_Current_Calls_List_Confirmation_Message_t;

#define HFRM_QUERY_CURRENT_CALLS_LIST_CONFIRMATION_MESSAGE_SIZE   (sizeof(HFRM_Query_Current_Calls_List_Confirmation_Message_t))
...
typedef struct _tagHFRM_Arbitrary_Response_Indication_Message_t
{
   ...
   /* asynchronous event message given the length (in characters) of the*/
   /* arbitrary response data.  This MACRO accepts as it's input the    */
   /* total number of characters (including the NULL terminator) that   */
   /* are present starting from the ArbitraryResponse member of the          */
