...
BTPSAPI_DECLARATION int BTPSAPI DEVM_SetRemoteDeviceLinkActive(BD_ADDR_t RemoteDevice);
   ...
   /* * NOTE * When called from a PM Client application, the            */
   /*          PersistClient parameter indicates whether the Service    */
   /*          Record should persist after the client application       */
   /*          disconnects from the PM Server.  If the parameter is     */
   /*          FALSE, the Service Record will automatically be removed  */
   /*          when the application exits).                             */
   /* * NOTE * The Persistclient parameter has no meaning when called by*/
   /*          a PM Server process and will be ignored.                 */
