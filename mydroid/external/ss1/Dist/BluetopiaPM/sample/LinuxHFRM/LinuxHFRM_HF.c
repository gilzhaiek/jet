...
static int DisplayHelp(ParameterList_t *TempParam)
{
   ...
   printf("*                  64)HFRRegisterEventCallback                   *\r\n");
   printf("*                  65)HFRUnRegisterEventCallback                 *\r\n");
   printf("*                  66)HFRRegisterDataCallback                    *\r\n");
   printf("*                  67)HFRUnRegisterDataCallback                  *\r\n");

   /* Application configuration commands.                               */
   printf("*                  68)SetSCOTestMode                             *\r\n");
