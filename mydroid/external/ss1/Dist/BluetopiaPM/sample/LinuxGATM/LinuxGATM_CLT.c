...
static int GATTWriteValueCommand(ParameterList_t *TempParam)
{
   ...
   if(Initialized)
   {
      ...
      if(GATMCallbackID)
      {
         ...
         {
            /* One or more of the necessary parameters is/are invalid.  */
            printf("Usage: WriteValueCommand [BD_ADDR] [AttributeHandle] [Format (0 = ASCII String, 1 = Hex String)] [Value] [Perform Signed Write (0 = Write Command, 1 = Signed Write Command)].\r\n");
...
static int StartAdvertising(ParameterList_t *TempParam)
{
   ...
   if(Initialized)
   {
      ...
      else
      {
         ...
         printf("    0x00000008 = Advertise Name\r\n");
         printf("    0x00000010 = Advertise Tx Power\r\n");
         printf("    0x00000020 = Advertise Appearance\r\n");
