      ...
      if(HDSventCallbackID)
      {
         ...
         if((TempParam) && (TempParam->NumberofParameters > 0))
         {
            ...
            if(!Result)
            {
               ...
               Result = HDSM_Connect_Remote_Device(sctHeadset, BD_ADDR, ServerPortNumber, ConnectionFlags, HDSM_Event_Callback, NULL, NULL);
   ...
   if(Initialized)
   {
      ...
      if(HDSventCallbackID)
      {
         ...
         if((TempParam) && (TempParam->NumberofParameters > 0))
         {
            ...
            Result = HDSM_Disconnect_Device(sctHeadset, BD_ADDR);
   ...
   if(Initialized)
   {
      ...
      if(HDSventCallbackID)
      {
         ...
         if((TempParam) && (TempParam->NumberofParameters > 1))
         {
            ...
            Result = HDSM_Connection_Request_Response(sctHeadset, BD_ADDR, (Boolean_t)(TempParam->Params[1].intParam));
