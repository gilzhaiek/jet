...
public class AltitudeModel implements ServiceConnection , MetricChangedListener{
    ...
    public void onResume() {
        ...
        try {
            mHUDMetricManager.registerMetricListener(this, HUDMetricIDs.ALTITUDE_CALIBRATED);
            mHUDMetricManager.registerMetricListener(this, HUDMetricIDs.ALTITUDE_GPS);
            mHUDMetricManager.registerMetricListener(this, HUDMetricIDs.ALTITUDE_PRESSURE);
            mHUDMetricManager.registerMetricListener(this, HUDMetricIDs.ALTITUDE_DELTA);
    ...
    public void onPause() {
        try {
            mHUDMetricManager.unregisterMetricListener(this, HUDMetricIDs.ALTITUDE_CALIBRATED);
            mHUDMetricManager.unregisterMetricListener(this, HUDMetricIDs.ALTITUDE_GPS);
            mHUDMetricManager.unregisterMetricListener(this, HUDMetricIDs.ALTITUDE_PRESSURE);
            mHUDMetricManager.unregisterMetricListener(this, HUDMetricIDs.ALTITUDE_DELTA);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
