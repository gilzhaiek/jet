...
public class AltitudeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGPSAlt = new MetricView((TextView)findViewById(R.id.AltitudeGPSCurrent), (TextView)findViewById(R.id.AltitudeGPSPrevious));
    ...
    private MetricView GetData(int metricID) {
        if(metricID == HUDMetricIDs.ALTITUDE_CALIBRATED){
            return mCalAlt;
        }
        else if(metricID == HUDMetricIDs.ALTITUDE_DELTA){
            return mDeltaAlt;
        }
        else if(metricID == HUDMetricIDs.ALTITUDE_GPS){
            return mGPSAlt;
        }
        else if(metricID == HUDMetricIDs.ALTITUDE_PRESSURE){
            return mPressureAlt;
        }
        return null;
    }
