...
void AudioResamplerSpeex::init() {
    int err;
    ALOGV("AudioResamplerSpeex::init() mChannelCount=%u, mInSampleRate=%u, "
...
AudioResamplerSpeex::~AudioResamplerSpeex() {
    ALOGV("AudioResamplerSpeex::~AudioResamplerSpeex()");
...
void AudioResamplerSpeex::setSampleRate(int32_t inSampleRate) {
    ...
    */
    ...
    ALOGV("AudioResamplerSpeex::setSampleRate() mChannelCount=%u, "
