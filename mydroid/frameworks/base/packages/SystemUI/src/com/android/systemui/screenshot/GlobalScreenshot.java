...
class SaveImageInBackgroundTask extends AsyncTask<SaveImageInBackgroundData, Void,
    ...
    protected void onPostExecute(SaveImageInBackgroundData params) {
	    ...
	    // Ali: We don't care about the final notification in status bar
	    /*postFinalNotification(params);*/
	    // lets just cancel the intermediate notification since image is saved
	    mNotificationManager.cancel(mNotificationId);
        }
        params.finisher.run();
    }

    protected void postFinalNotification(SaveImageInBackgroundData params) {
