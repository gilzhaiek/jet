...
public class PowerManager
{
   ...
   /**
     ...
     *
     * @return reason String for shutdown
     */
    ...
    /**
     * Set the brightness via the LightsService for a device
     *
     * @param id Light ID device. See LightsService.LIGHT_ID_XXX.
     *
    ...
    {
        try {
            mService.setBrightness(id, brightness);
        } catch (RemoteException e) {
    ...
    public int getBrightness(int id)
    {
        int brightness = -1;
        try {
            brightness = mService.getBrightness(id);
        } catch (RemoteException e) {
            Log.e(TAG, "Failed to get brightness!");
        }
        return brightness;
    }

    /**
     * Set the flashing via the LightsService for a device
     *
     * @param id Light ID device. See LightsService.LIGHT_ID_XXX.
     *
     * @param color Color of light to flash.
     *
     * @param onMs Duration of time to turn on.
     *
     * @param offMs Duration of time to turn off.
     *
     */
    public void setFlashing(int id, int color, int onMs, int offMs)
    {
        try {
            mService.setFlashing(id, color, onMs, offMs);
        } catch (RemoteException e) {
            Log.e(TAG, "Failed to set flashing!");
        }
    }
