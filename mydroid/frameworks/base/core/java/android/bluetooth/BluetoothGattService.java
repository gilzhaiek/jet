...
public class BluetoothGattService {
    ...
    /**
     * Recon: used to store ATT handlers
     * @hide
     */
    protected int mStartHandle, mEndHandle; 
    /**
     ...
     */
    /*package*/ BluetoothGattService(BluetoothDevice device, UUID uuid,
                                     int instanceId, int serviceType, int startHandle,int endHandle) {
        mDevice = device;
        mUuid = uuid;
        mInstanceId = instanceId;
        mServiceType = serviceType;
    ...
    /**
     * Recon: Returns the service start ATT handle.
     * @hide
     */
    ...
    /**
     * Recon: Returns the service end ATT handle.
     * @hide
     */
    ...
    /**
     * Get characteristic by ATThandle.
     * @hide
     */
    /*package*/ BluetoothGattCharacteristic getCharacteristic(int handle) {
        for(BluetoothGattCharacteristic characteristic : mCharacteristics) {
    ...
    /**
     * Get characteristic by UUID and ATThandle.
     * @hide
     */
    /*package*/ BluetoothGattCharacteristic getCharacteristic(UUID uuid, int handle) {
        for(BluetoothGattCharacteristic characteristic : mCharacteristics) {
            if (uuid.equals(characteristic.getUuid()) &&
                    characteristic.getInstanceId() == handle)
                return characteristic;
        }
        return null;
    }
    ...
    /**
     * Get characteristic based on descriptor ATThandle.
     * @hide
     */
    BluetoothGattCharacteristic getCharacteristicFromDescHandle(int handle) {
        BluetoothGattCharacteristic Characteristic = null;
        int MinimumOffset = 0xffff; //Maximum offset between two ATThandles
        int min;
        for(BluetoothGattCharacteristic characteristic : mCharacteristics) {
            min = handle - characteristic.getInstanceId();
            if (min>0 && min <=MinimumOffset)
            {
                MinimumOffset = min;
