...
public final class BluetoothDevice implements Parcelable {
    ...
    public void SetDeviceBrEdr() {
        if(SystemProperties.BLUETI_ENHANCEMENT)
            mDeviceType = DEVICE_TYPE_CLASSIC;
    }
    ...
    public int getType() {
          ...
          //Recon is using SS1 stack to qury device type
          try {
              IBluetoothGatt iGatt = sService.getBluetoothGatt();
               if (iGatt == null) {
                    return DEVICE_TYPE_UNKNOWN;
               }
               return iGatt.getDeviceType(mAddress);
          } catch (RemoteException e) {Log.e(TAG, "", e);}
          return DEVICE_TYPE_UNKNOWN;
    }
    /**
