 ...
 *     <li> {@link #ACTION_SHUTDOWN_REASON}
...
public class Intent implements Parcelable, Cloneable {
    ...
    /**
     * Broadcast Action:  Indicates the reason the device was shutdown
     *
     * <p class="note">This is a protected intent that can only be sent
     * by the system.
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_SHUTDOWN_REASON = "android.intent.action.SHUTDOWN_REASON";
    /**
