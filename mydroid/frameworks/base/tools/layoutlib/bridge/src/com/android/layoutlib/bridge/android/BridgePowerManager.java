...
public class BridgePowerManager implements IPowerManager {
    ...
    @Override
    public String getLastShutdownReason() throws RemoteException {
        return "";
    }
    ...
    @Override
    public void setBrightness(int id, int brightness) throws RemoteException {
        // pass for now.
    }

    @Override
    public int getBrightness(int id) throws RemoteException {
        // pass for now.
        return 0;
    }

    @Override
    public void setFlashing(int id, int color, int onMs, int offMs) throws RemoteException {
        // pass for now.
    }
