...
static void location_callback(GpsLocation* location)
{
    ...
    env->CallVoidMethod(mCallbacksObj, method_reportLocation, location->flags,
            ...
            (jdouble)location->altitude, (jdouble)location->msl_altitude,
...
static void android_location_GpsLocationProvider_class_init_native(JNIEnv* env, jclass clazz) {
    ...
    method_reportLocation = env->GetMethodID(clazz, "reportLocation", "(IDDDDFFFJ)V");
...
static void android_location_GpsLocationProvider_cleanup(JNIEnv* env, jobject obj, jboolean stop_server)
{
    if (sGpsInterface)
        sGpsInterface->cleanup(stop_server);
}
...
static JNINativeMethod sMethods[] = {
    ...
    {"native_cleanup", "(Z)V", (void*)android_location_GpsLocationProvider_cleanup},
