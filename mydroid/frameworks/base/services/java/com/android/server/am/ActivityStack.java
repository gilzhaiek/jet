...
final class ActivityStack {
    ...
    void awakeFromSleepingLocked() {
        ...
        // ANALYTICS
        mService.sendAnalyticsEvent("DeviceWakeup", "", "", "");
    }
    ...
    void checkReadyForSleepLocked() {
        ...
        // ANALYTICS
        mService.sendAnalyticsEvent("DeviceSleep", "", "", "");
    ...
    private final void completePauseLocked() {
        ...
        // ANALYTICS
        mService.sendAnalyticsEvent("PauseActivity", prev.shortComponentName, "", "");
    ...
    private final void completeResumeLocked(ActivityRecord next) {
        ...
        // ANALYTICS
        mService.sendAnalyticsEvent("ResumeActivity", next.shortComponentName, "", "");
