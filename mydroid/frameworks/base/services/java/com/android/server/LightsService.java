...
public class LightsService {
    ...
    public final class Light {
        ...
        public void turnOff() {
            synchronized (this) {
                if(!mFlashedOnce && (mId == LIGHT_ID_NOTIFICATIONS)) { // Don't Turnoff if we didn't flash yet - this is the "MidKernel" screen
                    return;
                }
        ...
        private int getLightLocked() {
            return getLight_native(mNativePointer, mId);
        }
        ...
        private boolean mFlashedOnce = false;
    }
    ...
    private static native int getLight_native(int ptr, int light);
