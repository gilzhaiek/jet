...
<a class="totop" href="#top" data-g-event="left-nav-top">to top</a>
      <div id="api-nav-header">
        <div id="api-nav-title">Recon SDK APIs</div>
        </div><!-- end nav header -->
      <script>
        var SINCE_DATA = [ <?cs 
          each:since = since ?>'<?cs 
...
def:custom_copyright() ?>
  ...
  href="http://www.apache.org/licenses/LICENSE-2.0">Apache 2.0</a>.<?cs 
/def ?>

<?cs 
def:custom_footerlinks() ?>
  <p>
    <a href="http://www.reconinstruments.com">About Recon</a>&nbsp;&nbsp;|&nbsp;
    <a href="http://www.reconinstruments.com/developers/getting-started/reconsdk/">Recon SDK</a>&nbsp;&nbsp;|&nbsp;
    <a href="http://reconinstruments.desk.com">Support</a>
  </p><?cs 
/def ?>

<?cs # appears on the right side of the blue bar at the bottom off every page ?><?cs 
def:custom_buildinfo() ?>
  Recon Instruments - <?cs var:page.now ?>
<?cs /def ?>
