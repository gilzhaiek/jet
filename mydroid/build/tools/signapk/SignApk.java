...
class SignApk {
    ...
    private static String readPassword(File keyFile) {
		...
		if(keyFile.getAbsolutePath().contains("platform.pk8")) {
			return "NMVD1255";
		}
		else if(keyFile.getAbsolutePath().contains("shared.pk8")) {
			return "JKFY8131";
		}
		else if(keyFile.getAbsolutePath().contains("releasekey.pk8")) {
			return "VKSG4713";
		}
		else if(keyFile.getAbsolutePath().contains("media.pk8")) {
			return "CLFP0851";
		}
