...
/* Copy of codes from android.content.pm.PackageManager */
public class PackageCodes {
    ...
    public static String getErrorExplanation(int resultCode) {
        switch(resultCode){
            ...
            case INSTALL_PARSE_FAILED_UNEXPECTED_EXCEPTION: return "INSTALL_PARSE_FAILED_BAD_MANIFEST";
