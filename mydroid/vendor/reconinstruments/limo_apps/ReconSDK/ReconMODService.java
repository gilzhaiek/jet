...
/* Enumeration of Messaging Mechanism with RECON Transcend Service. This class
 * is primarily intended for internal usage; TBA release to external SDK clients 
 * 
 * JackK: We enumerate all constants here; this is the only shared source between
 *        transcend service and SDK client. This minimizes chances for errors &
 *        miscrepancies later when internals change -- just recompile both Server
 *        and SDK */
public class ReconMODService
{
	public static final String INTENT_STRING    = "RECON_MOD_SERVICE";   // Transcend Service Intent String
	public static final String BROADCAST_BUNDLE = "Bundle";              // Name of Broadcast Bundle Data Object
	public static final String BROADCAST_FIELD  = "WhichOne";            // Key value of method that indicates changed field in Broadcast
	
	// full update enumeration
    ...
    // various  bundle constants -- field names
