...
public class ShowFacebookCommentsActivity extends Activity {

	private static final String TAG = "ShowFacebookCommentsActivity";
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		navText    = (TextView) findViewById(R.id.msgnav_text);
	...
	private void navigate ()
	{
		...
		navText.setText(" comments on this post");
