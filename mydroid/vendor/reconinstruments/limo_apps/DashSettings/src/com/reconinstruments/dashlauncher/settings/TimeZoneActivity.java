...
public class TimeZoneActivity extends ListActivity {			
	...
	public void onCreate(Bundle savedInstanceState){
		...
		checkedIndex = null;
		String tzIdStr = tz.getID();
		if("GMT".equals(tzIdStr)){// convert GMT to Pacific Time as our default time zone.
			tzIdStr = "America/Los_Angeles";
		}
		for(SettingItem m : (ArrayList<SettingItem>) timeZoneLists) {
			if(tzIdStr.equals((String)mTimeZones.get(timeZoneLists.indexOf(m)).get(KEY_ID))) {
