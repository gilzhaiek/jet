...
public class ReconSnowAreaRecord extends ReconSnowDataRecord 
{
	private final static String TAG = "ReconSnowAreaRecord";
	
	public ArrayList<PointXY>	mPolylineNodes;
	public RectXY				mBoundingBox;
	public PointXY				mCentroid;
	
	public ReconSnowAreaRecord(ReconSnowDataSource.BaseDataTypes type, String name, ArrayList<PointXY> nodes, boolean isUserLocationDependent) {
