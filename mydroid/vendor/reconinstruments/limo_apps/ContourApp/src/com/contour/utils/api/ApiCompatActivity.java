 ...
 */
public abstract class ApiCompatActivity extends Activity {
    final ApiHelper mApiHelper = ApiHelper.createInstance(this);
    ...
    public MenuInflater getMenuInflater() {
        return mApiHelper.getMenuInflater(super.getMenuInflater());
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mApiHelper.onCreate(savedInstanceState);
    }
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        mApiHelper.onPostCreate(savedInstanceState);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        retValue |= mApiHelper.onCreateOptionsMenu(menu);
    ...
    protected void onTitleChanged(CharSequence title, int color) {
        mApiHelper.onTitleChanged(title, color);
