...
public abstract class ActionBarHelper {
    ...
    public abstract void setDisabledActionItemState(boolean disabled);
    
    public abstract void setCloseActionItemState(boolean closeable);
    ...
    public abstract View setTitleView(int resId);
