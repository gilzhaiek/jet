...
public class ApiHelperBase extends ApiHelper
{
    ...
    protected ApiHelperBase(Activity activity)
    {
        super(activity);
    }
    ...
    protected HttpClient getHttpClient(String userAgentString)
    {
        ...
        HttpConnectionParams.setSoTimeout(params, 20);
