...
public class Washroom extends WO_POI  implements Parcelable
{
	private final static String TAG = "Washroom";

	public Washroom(String name, PointXY _gpsLocation, Capability.DataSources dataSource) {
		super(WorldObjectTypes.WASHROOM, name, _gpsLocation, dataSource);
	}


	public Washroom(Parcel _parcel) {					
...
//============ parcelable protocol handlers
    ...
    public static final Parcelable.Creator<Washroom> CREATOR  = new Parcelable.Creator<Washroom>() {
        public Washroom createFromParcel(Parcel _parcel) {
            return new Washroom(_parcel);
        }

        public Washroom[] newArray(int size) {
            return new Washroom[size];
        }
    };
