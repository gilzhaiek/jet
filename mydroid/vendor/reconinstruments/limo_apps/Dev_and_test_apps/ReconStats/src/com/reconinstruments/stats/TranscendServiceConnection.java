...
public class TranscendServiceConnection implements ServiceConnection {
	...
	private StatsTabView mStatsView;
	...
	public void setViewToUpdate(StatsTabView statsView) {
		mStatsView = statsView;
	}
	...
	public void resetStats() {
		if (mConnectionStatus == CONNECTION_STATUS_BOUND) {
			...
			Log.e("ReconStats:",
					"Try to reset stats but the transcend service is not connected yet");
		}
	}
