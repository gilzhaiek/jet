...
public class BestAirTabPage extends ReconTabPage {
	
	public BestAirTabPage(Context context, Drawable iconRegular,
			Drawable iconSelected, Drawable iconFocused, TabView hostView) {
		super(context, iconRegular, iconSelected, iconFocused, hostView,"BEST AIR");
