...
public class Activity_WatchScanList extends FragmentActivity
{
    ...
    private void resetPcc()
    {
        ...
        AntPlusWatchDownloaderPcc.requestDeviceListAccess(this, 
                ...
                RequestAccessResult resultCode, DeviceState initialDeviceState)
            {
                switch(resultCode)
                {
                    ...
                    case UNRECOGNIZED:
                        ...
                        Toast.makeText(Activity_WatchScanList.this, "Failed: UNRECOGNIZED. Upgrade Required?", Toast.LENGTH_SHORT).show();
                        tv_status.setText("Error. Do Menu->Reset.");
                        break;
                    default:
