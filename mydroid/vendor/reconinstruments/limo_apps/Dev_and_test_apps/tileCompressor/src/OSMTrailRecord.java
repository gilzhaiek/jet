...
public class OSMTrailRecord extends OSMDataRecord 
{
	private final static String TAG = "OSMTrailRecord";
	...
	public OSMTrailRecord(TileCompressor.OSMBaseDataTypes type, String name, ArrayList<PointXY> nodes, int speedLimit, boolean isOneWay, boolean isUserLocationDependent) {
