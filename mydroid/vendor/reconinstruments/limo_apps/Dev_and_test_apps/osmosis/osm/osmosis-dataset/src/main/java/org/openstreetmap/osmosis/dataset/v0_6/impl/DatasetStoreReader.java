...
public class DatasetStoreReader implements DatasetContext {
	...
	public ReleasableIterator<EntityContainer> iterateBoundingBox(
		...
		LOG.warning("-------DatasetStoreReader.iterateBoundingBox eginning bounding box iteration.");
	...
	public ReleasableIterator<EntityContainer> iterateBoundingBox2(
		...
		LOG.warning("-------DatasetStoreReader.iterateBoundingBox2 eginning bounding box iteration.");
