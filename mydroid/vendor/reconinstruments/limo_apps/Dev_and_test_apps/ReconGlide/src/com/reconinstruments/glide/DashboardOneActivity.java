...
public class DashboardOneActivity extends Activity {
	...
	private TextView speedField, speedUnitField, glideField, glideTitle, altField;
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
    	...
    	case KeyEvent.KEYCODE_DPAD_RIGHT:
    		Intent myIntent = new Intent(this, DashboardTwoActivity.class);
