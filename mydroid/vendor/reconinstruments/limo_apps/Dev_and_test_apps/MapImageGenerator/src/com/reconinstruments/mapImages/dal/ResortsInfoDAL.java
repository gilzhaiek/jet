...
import com.reconinstruments.mapImages.helpers.AssetDB;
...
public class ResortsInfoDAL {
	...
	public void LoadResortsInfo(ResortsInfo resortsInfo) throws Exception {
		...
		try {
			...
			Log.e(TAG, "Wasn't able to LoadResortsInfo " + exception.toString());
