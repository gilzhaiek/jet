 ...
 * http://b.ivity.asia/2010/12/01/extended-marquee-in-android/
 */
public class MarqueeViewSingle extends LinearLayout {
    public TextView mTextField1;
     ...
     */
    public static final int PAUSE_BETWEEN_ANIMATIONS = 3000;
    ...
    public void reset() {
        if(DEBUG) Log.d(TAG, "Resetting animation.");
        ...
        // occasionally reset will be called before the view is prepared, this is a hacky fix to prevent a crash
        if(mMoveText1TextOut!=null)
        	mMoveText1TextOut.reset();
        if(mMoveText1TextIn!=null)
...
//                mMoveText1TextOutPlaying = false;
    ...
    public String getText() {
    	return (String) mTextField1.getText();
    }
    ...
    public void setTextSize(int unit, int size) {
    	mTextField1.setTextSize(unit, size);
    }
