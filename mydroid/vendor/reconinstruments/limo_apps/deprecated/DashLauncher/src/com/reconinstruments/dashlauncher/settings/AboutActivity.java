...
public class AboutActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		RelativeLayout view = (RelativeLayout) findViewById(R.id.setting_about_version);
		...
		view = (RelativeLayout) findViewById(R.id.setting_about_serial);
		tv = (TextView) view.findViewById(R.id.setting_text);
		tv.setText("Serial Number");
		tv = (TextView) view.findViewById(R.id.setting_subtext);
		tv.setText(Build.SERIAL);
				
		view = (RelativeLayout) findViewById(R.id.setting_about_model);
		tv = (TextView) view.findViewById(R.id.setting_text);
		tv.setText("Model");
		tv = (TextView) view.findViewById(R.id.setting_subtext);
		tv.setText(Build.MODEL);
				
		view = (RelativeLayout) findViewById(R.id.setting_about_android);
		tv = (TextView) view.findViewById(R.id.setting_text);
		tv.setText("Android OS");
		tv = (TextView) view.findViewById(R.id.setting_subtext);
		tv.setText(Build.VERSION.RELEASE);
		
		view = (RelativeLayout) findViewById(R.id.setting_about_build);
		tv = (TextView) view.findViewById(R.id.setting_text);
		tv.setText("Build");
		tv = (TextView) view.findViewById(R.id.setting_subtext);
		tv.setText(Build.DISPLAY);
		
		view = (RelativeLayout) findViewById(R.id.setting_about_kernel);
		tv = (TextView) view.findViewById(R.id.setting_text);
		tv.setText("Kernel");
		tv = (TextView) view.findViewById(R.id.setting_subtext);
