...
public class ReconPickerView extends FrameLayout {
	...
	private void initButtons() {
		...
		numberPickerDown = (LinearLayout) this
				.findViewById(com.reconinstruments.widgets.R.id.numberPickerDown);
		numberPickerUp = (LinearLayout) this
				.findViewById(com.reconinstruments.widgets.R.id.numberPickerUp);
		pickerInput = (EditText) this
				.findViewById(com.reconinstruments.widgets.R.id.pickerInput);
	...
	private void inflateView(Context context) {
		...
		View pickerView = factory.inflate(
				com.reconinstruments.widgets.R.layout.picker_view, null);
