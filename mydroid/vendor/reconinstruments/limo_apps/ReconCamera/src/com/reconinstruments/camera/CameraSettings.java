...
import com.reconinstruments.camera.preference.IconListPreference;
...
import com.reconinstruments.camera.preference.PreferenceInflater;
...
public class CameraSettings {
    ...
    public static String getSupportedHighestVideoQuality(int cameraId,
        ...
        // TODO Some bug here. Firmware says it supports 1080p even though it is not supported
        // 0 will return 1080p, therefore set from the default value when getting value from pref
    }
    ...
    private void initPreference(PreferenceGroup group) {
        ...
        if (cameraHdrPlus != null && (!ApiHelper.HAS_CAMERA_HDR_PLUS || isFrontCamera)) {
    ...
    private static ArrayList<String> getSupportedVideoQuality(int cameraId) {
        ...
        // Due to some bug in JET camera driver doesn't return 5, it returns 6 which is 1080p
        // Not Supported in Jet TODO put it back later when we support 1080p
