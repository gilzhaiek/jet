...
public class LocalDataList {
	private static final String TAG = "LocalDataList";
    /**
    ...
    public LocalData remove(int index) {
        ...
        LocalData check = mUriMap.remove(removedItem.getContentUri());
        
        if(check == null) Log.e(TAG, "Couldn't find key in Uri hashmap!");
        return removedItem;
    }
