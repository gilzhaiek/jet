...
public class IntArray {
    ...
    /**
     * copy the content of mData[] to result array.
     * <br>
     * If the result.length < mSize or result == 0
     * then create a new result array and copy mData into result
     * 
     * @param result
     * @return result with data copied
     */
