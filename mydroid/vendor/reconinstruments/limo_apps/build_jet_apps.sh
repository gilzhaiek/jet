...
PREBUILD_APKS=${YOUR_PATH}/prebuilt_apks
sign_apps=0
...
# copy unsigned prebuild stuff
echo "033[1;32mPrebuilt apps";
cp ${PREBUILD_APKS}/*.apk $APKS_OUT_FOLDER/
...
cd ${YOUR_PATH}/Android_MobileSDK/CommonUtil/
android update project -p . -t android-16
ant debug
...
cd ${YOUR_PATH}/Android_MobileSDK/WebApi/
bash make_app.bash
