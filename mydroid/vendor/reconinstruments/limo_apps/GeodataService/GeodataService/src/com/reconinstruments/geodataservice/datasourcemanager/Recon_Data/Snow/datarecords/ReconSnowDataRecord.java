...
import com.reconinstruments.geodataservice.datasourcemanager.Recon_Data.Snow.ReconSnowDataSource.BaseDataTypes;
import com.reconinstruments.mapsdk.geodataservice.clientinterface.worldobjects.RectXY;

public class ReconSnowDataRecord 
{
	private final static String TAG = "ReconSnowDataRecord";
	protected final static int BYTES_IN_FLOAT = Float.SIZE/8;
	protected final static int BYTES_IN_SHORT = Short.SIZE/8;

	public ReconSnowDataSource.BaseDataTypes	mDataType;
	public String								mName;

	public ReconSnowDataRecord(ReconSnowDataSource.BaseDataTypes dataType, String name, boolean isUserLocationDependent) {
		mDataType = dataType;
		mName = name;
	}	
