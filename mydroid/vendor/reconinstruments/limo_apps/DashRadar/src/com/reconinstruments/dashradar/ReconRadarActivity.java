package com.reconinstruments.dashradar;
...
import com.reconinstruments.dashlauncher.radar.BaseControllerHelper;
import com.reconinstruments.dashlauncher.radar.ControllersManager;
import com.reconinstruments.dashlauncher.radar.RadarGLController;
import com.reconinstruments.dashlauncher.radar.RadarViewControllerHelper;
...
public class ReconRadarActivity extends ColumnElementActivity implements HeadingListener
{
	...
	if(Settings.Secure.getInt(getContentResolver(), "hasWrittenMagOffsetsV2", 0)!=1) { // If mag offsets have not been written
