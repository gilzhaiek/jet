...
public class DevelopmentSettings extends PreferenceFragment
    ...
    private static final String ENABLE_AVG_CURRENT = "enable_avg_current";
    ...
    private CheckBoxPreference mEnableAvgCurrent;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mEnableAvgCurrent = findAndInitCheckboxPref(ENABLE_AVG_CURRENT);
    ...
    private void updateAllOptions() {
        ...
        updateCheckBox(mEnableAvgCurrent, Settings.System.getInt(cr,
                Settings.System.AVG_CURRENT_ENABLED, 0) != 0);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        } else if (preference == mEnableAvgCurrent) {
            Settings.System.putInt(getActivity().getContentResolver(),
                        Settings.System.AVG_CURRENT_ENABLED,
                        mEnableAvgCurrent.isChecked() ? 1 : 0);
