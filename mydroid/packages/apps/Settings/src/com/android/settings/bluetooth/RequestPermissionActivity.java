...
public class RequestPermissionActivity extends Activity implements
    ...
    private void createDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this, com.android.internal.R.style.Theme_DeviceDefault_Dialog_Alert);
        ...
        if (mNeededToEnableBluetooth) {
            ...
            // Changed by patrick from getString(R.string.yes) to "CONTINUE", getString(R.string.no) to "CANCEL" 
